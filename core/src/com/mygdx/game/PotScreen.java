...
public class PotScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        if(gameTimer<=0) {
            ...
            layout.setText(font1,"Сезнең нәтиҗә: "+Integer.toString(point) );
            font1.draw(main.batch,"Сезнең нәтиҗә: "+Integer.toString(point),retryButton.x+retryButton.width/2f-layout.width/2f,retryButton.y+retryButton.height/2f+layout.height/2);
        }
